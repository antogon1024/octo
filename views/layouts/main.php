...
<header>
    ...
    NavBar::begin([
        'brandLabel' => '<img src="/web/img/logo.svg"; class="img-responsive">',
        'brandUrl' => Yii::$app->homeUrl,
        'options' => [
            'class' => 'navbar navbar-expand-md navbar-dark 2bg-dark 2fixed-top',
        ],
    ]);
    ...
    if (Yii::$app->user->isGuest && $url == 'site/index') {
